...
always @ (posedge ap_clk) begin
    ...
    end else if ((~((1'b0 == INPUT_STREAM_TVALID_int) & (eol_2_i_reg_368 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (eol_2_i_reg_368 == 1'd0))) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_predicate_op67_read_state5 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001)) | ((1'b1 == INPUT_STREAM_TVALID_int) & (1'b1 == ap_CS_fsm_state2)) | (~((1'b0 == INPUT_STREAM_TVALID_int) & (eol_2_i_reg_368 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (eol_2_i_reg_368 == 1'd0)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == INPUT_STREAM_TVALID_int) & (1'b1 == ap_CS_fsm_state2) & (tmp_user_V_fu_396_p1 == 1'd0))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if (((1'b1 == INPUT_STREAM_TVALID_int) & (tmp_user_V_fu_396_p1 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        ap_ST_fsm_state8 : begin
            if ((~((1'b0 == INPUT_STREAM_TVALID_int) & (eol_2_i_reg_368 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (eol_2_i_reg_368 == 1'd0))) begin
                ap_NS_fsm = ap_ST_fsm_state8;
            end else if ((~((1'b0 == INPUT_STREAM_TVALID_int) & (eol_2_i_reg_368 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (ap_phi_mux_eol_2_i_phi_fu_371_p4 == 1'd1))) begin
...
always @ (*) begin
    ap_block_state8 = ((1'b0 == INPUT_STREAM_TVALID_int) & (eol_2_i_reg_368 == 1'd0));
end
...
assign tmp_user_V_fu_396_p1 = INPUT_STREAM_TUSER_int;
