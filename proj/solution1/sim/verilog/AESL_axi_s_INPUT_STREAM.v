...
`define TV_IN_INPUT_STREAM_TDATA "../tv/cdatafile/c.sobel_accel.autotvin_INPUT_STREAM_V_data_V.dat"
`define INGRESS_STATUS_INPUT_STREAM_TDATA "../tv/stream_size/stream_ingress_status_INPUT_STREAM_V_data_V.dat"
`define TV_IN_INPUT_STREAM_TKEEP "../tv/cdatafile/c.sobel_accel.autotvin_INPUT_STREAM_V_keep_V.dat"
`define INGRESS_STATUS_INPUT_STREAM_TKEEP "../tv/stream_size/stream_ingress_status_INPUT_STREAM_V_keep_V.dat"
`define TV_IN_INPUT_STREAM_TSTRB "../tv/cdatafile/c.sobel_accel.autotvin_INPUT_STREAM_V_strb_V.dat"
`define INGRESS_STATUS_INPUT_STREAM_TSTRB "../tv/stream_size/stream_ingress_status_INPUT_STREAM_V_strb_V.dat"
`define TV_IN_INPUT_STREAM_TUSER "../tv/cdatafile/c.sobel_accel.autotvin_INPUT_STREAM_V_user_V.dat"
`define INGRESS_STATUS_INPUT_STREAM_TUSER "../tv/stream_size/stream_ingress_status_INPUT_STREAM_V_user_V.dat"
`define TV_IN_INPUT_STREAM_TLAST "../tv/cdatafile/c.sobel_accel.autotvin_INPUT_STREAM_V_last_V.dat"
`define INGRESS_STATUS_INPUT_STREAM_TLAST "../tv/stream_size/stream_ingress_status_INPUT_STREAM_V_last_V.dat"
`define TV_IN_INPUT_STREAM_TID "../tv/cdatafile/c.sobel_accel.autotvin_INPUT_STREAM_V_id_V.dat"
`define INGRESS_STATUS_INPUT_STREAM_TID "../tv/stream_size/stream_ingress_status_INPUT_STREAM_V_id_V.dat"
`define TV_IN_INPUT_STREAM_TDEST "../tv/cdatafile/c.sobel_accel.autotvin_INPUT_STREAM_V_dest_V.dat"
...
module AESL_axi_s_INPUT_STREAM (
    ...
    fifo #(2073600, 24) fifo_INPUT_STREAM_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(2073600, 3) fifo_INPUT_STREAM_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(2073600, 3) fifo_INPUT_STREAM_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
