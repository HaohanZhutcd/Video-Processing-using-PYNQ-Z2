...
`define TV_OUT_OUTPUT_STREAM_TDATA "../tv/rtldatafile/rtl.sobel_accel.autotvout_OUTPUT_STREAM_V_data_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TDATA "../tv/stream_size/stream_egress_status_OUTPUT_STREAM_V_data_V.dat"
`define TV_OUT_OUTPUT_STREAM_TKEEP "../tv/rtldatafile/rtl.sobel_accel.autotvout_OUTPUT_STREAM_V_keep_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TKEEP "../tv/stream_size/stream_egress_status_OUTPUT_STREAM_V_keep_V.dat"
`define TV_OUT_OUTPUT_STREAM_TSTRB "../tv/rtldatafile/rtl.sobel_accel.autotvout_OUTPUT_STREAM_V_strb_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TSTRB "../tv/stream_size/stream_egress_status_OUTPUT_STREAM_V_strb_V.dat"
`define TV_OUT_OUTPUT_STREAM_TUSER "../tv/rtldatafile/rtl.sobel_accel.autotvout_OUTPUT_STREAM_V_user_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TUSER "../tv/stream_size/stream_egress_status_OUTPUT_STREAM_V_user_V.dat"
`define TV_OUT_OUTPUT_STREAM_TLAST "../tv/rtldatafile/rtl.sobel_accel.autotvout_OUTPUT_STREAM_V_last_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TLAST "../tv/stream_size/stream_egress_status_OUTPUT_STREAM_V_last_V.dat"
`define TV_OUT_OUTPUT_STREAM_TID "../tv/rtldatafile/rtl.sobel_accel.autotvout_OUTPUT_STREAM_V_id_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TID "../tv/stream_size/stream_egress_status_OUTPUT_STREAM_V_id_V.dat"
`define TV_OUT_OUTPUT_STREAM_TDEST "../tv/rtldatafile/rtl.sobel_accel.autotvout_OUTPUT_STREAM_V_dest_V.dat"
...
module AESL_axi_s_OUTPUT_STREAM (
    ...
    fifo #(2073600, 24) fifo_OUTPUT_STREAM_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(2073600, 3) fifo_OUTPUT_STREAM_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(2073600, 3) fifo_OUTPUT_STREAM_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
