...
`define TV_OUT_OUTPUT_STREAM_TDATA "./impl_rtl.sobel_accel.autotvout_OUTPUT_STREAM_V_data_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TDATA "./stream_egress_status_OUTPUT_STREAM_V_data_V.dat"
`define TV_OUT_OUTPUT_STREAM_TKEEP "./impl_rtl.sobel_accel.autotvout_OUTPUT_STREAM_V_keep_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TKEEP "./stream_egress_status_OUTPUT_STREAM_V_keep_V.dat"
`define TV_OUT_OUTPUT_STREAM_TSTRB "./impl_rtl.sobel_accel.autotvout_OUTPUT_STREAM_V_strb_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TSTRB "./stream_egress_status_OUTPUT_STREAM_V_strb_V.dat"
`define TV_OUT_OUTPUT_STREAM_TUSER "./impl_rtl.sobel_accel.autotvout_OUTPUT_STREAM_V_user_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TUSER "./stream_egress_status_OUTPUT_STREAM_V_user_V.dat"
`define TV_OUT_OUTPUT_STREAM_TLAST "./impl_rtl.sobel_accel.autotvout_OUTPUT_STREAM_V_last_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TLAST "./stream_egress_status_OUTPUT_STREAM_V_last_V.dat"
`define TV_OUT_OUTPUT_STREAM_TID "./impl_rtl.sobel_accel.autotvout_OUTPUT_STREAM_V_id_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TID "./stream_egress_status_OUTPUT_STREAM_V_id_V.dat"
`define TV_OUT_OUTPUT_STREAM_TDEST "./impl_rtl.sobel_accel.autotvout_OUTPUT_STREAM_V_dest_V.dat"
