...
`define TV_IN_INPUT_STREAM_TDATA "./c.sobel_accel.autotvin_INPUT_STREAM_V_data_V.dat"
`define INGRESS_STATUS_INPUT_STREAM_TDATA "./stream_ingress_status_INPUT_STREAM_V_data_V.dat"
`define TV_IN_INPUT_STREAM_TKEEP "./c.sobel_accel.autotvin_INPUT_STREAM_V_keep_V.dat"
`define INGRESS_STATUS_INPUT_STREAM_TKEEP "./stream_ingress_status_INPUT_STREAM_V_keep_V.dat"
`define TV_IN_INPUT_STREAM_TSTRB "./c.sobel_accel.autotvin_INPUT_STREAM_V_strb_V.dat"
`define INGRESS_STATUS_INPUT_STREAM_TSTRB "./stream_ingress_status_INPUT_STREAM_V_strb_V.dat"
`define TV_IN_INPUT_STREAM_TUSER "./c.sobel_accel.autotvin_INPUT_STREAM_V_user_V.dat"
`define INGRESS_STATUS_INPUT_STREAM_TUSER "./stream_ingress_status_INPUT_STREAM_V_user_V.dat"
`define TV_IN_INPUT_STREAM_TLAST "./c.sobel_accel.autotvin_INPUT_STREAM_V_last_V.dat"
`define INGRESS_STATUS_INPUT_STREAM_TLAST "./stream_ingress_status_INPUT_STREAM_V_last_V.dat"
`define TV_IN_INPUT_STREAM_TID "./c.sobel_accel.autotvin_INPUT_STREAM_V_id_V.dat"
`define INGRESS_STATUS_INPUT_STREAM_TID "./stream_ingress_status_INPUT_STREAM_V_id_V.dat"
`define TV_IN_INPUT_STREAM_TDEST "./c.sobel_accel.autotvin_INPUT_STREAM_V_dest_V.dat"
